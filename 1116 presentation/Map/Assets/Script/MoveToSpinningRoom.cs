...
public class MoveToSpinningRoom : MonoBehaviour
{
    ...
    private Vector3 spinningRoomPosition = new Vector3 (30f, 1.2f, 10f);
    ...
    void Update()
    {
        if (controller.enabled == false && (pressKeyOpenDoor.lockCinemachine == true || pressKeyOpenDoor2.lockCinemachine == true))   //  && turnCamera.flag == true
        {
            // delay
